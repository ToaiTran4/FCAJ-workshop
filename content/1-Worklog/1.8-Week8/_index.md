...
### Week 8 Objectives:
* Learn about the process of migrating systems to AWS: migrate virtual machines, convert database schema, move databases.
* Learn about system optimization solutions: automatically turn on/off EC2 with Slack notifications using AWS Lambda.
* Practice Lab8: build system monitoring dashboard with Amazon CloudWatch and Grafana.
* Learn about resource management by group using Tags and Resource Groups (Owner, Environment, Project); manage EC2 access by Tag through IAM.
...
### Week 8 Achievements:
* Learned about the process of migrating systems to AWS.
* Learned about system optimization solutions with automatic EC2 on/off and Slack notifications using Lambda.
* Successfully completed Lab8: built system monitoring dashboard with CloudWatch and Grafana.
* Learned about resource management using Tags and Resource Groups.
* Learned to manage EC2 access by Tag through IAM.
